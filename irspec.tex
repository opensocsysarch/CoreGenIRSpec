...
\pagestyle{fancy}
\lhead{}
\chead{\textbf{CoreGen IR Spec v.1.4.2}}
\rhead{}
\lfoot{} %-- format: TR YYYY-RRR-V.V; y = year; r = report; v = version
\cfoot{\textbf{CoreGen IR Spec v.1.4.2}}
...
\begin{center}
\begin{tabular}{l r}
Date: & July 03, 2019 \\ % Date the experiment was performed
Revision: & 1.4.2 \\         % revision number
