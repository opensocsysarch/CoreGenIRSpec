...
to as a \texttt{PseudoName}.  Additional parameters are described in Table~\ref{tab:RegNodeParams}.  We provide a sample register IR block in Listing~\ref{lis:registernode}.  
