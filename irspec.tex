...
\pagestyle{fancy}
\lhead{}
\chead{\textbf{CoreGen IR Spec v.1.4.6}}
\rhead{}
\lfoot{} %-- format: TR YYYY-RRR-V.V; y = year; r = report; v = version
\cfoot{\textbf{CoreGen IR Spec v.1.4.6}}
...
\begin{center}
\begin{tabular}{l r}
Date: & June 03, 2020 \\ % Date the experiment was performed
Revision: & 1.4.6 \\         % revision number
