...
\pagestyle{fancy}
\lhead{}
\chead{\textbf{CoreGen IR Spec v.1.4}}  % -- classification
\rhead{}
\lfoot{} %-- format: TR YYYY-RRR-V.V; y = year; r = report; v = version
\cfoot{\textbf{CoreGen IR Spec v.1.4}}  % -- classification
...
\begin{center}
\begin{tabular}{l r}
Date: & January 21, 2019 \\ % Date the experiment was performed
Revision: & 1.4 \\         % revision number
