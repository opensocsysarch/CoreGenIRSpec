...
\begin{versionhistory}
  ...
  \vhEntry{1.4.5}{12.30.2019}{JLeidel}{Adding LineSize cache line size parameter and memory ordering parameters; Adding read and write ports to register classes}
\end{versionhistory}
