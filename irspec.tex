...
\pagestyle{fancy}
\lhead{}
\chead{\textbf{CoreGen IR Spec v.1.3}}  % -- classification
\rhead{}
\lfoot{} %-- format: TR YYYY-RRR-V.V; y = year; r = report; v = version
\cfoot{\textbf{CoreGen IR Spec v.1.3}}  % -- classification
...
\begin{center}
\begin{tabular}{l r}
Date: & December 20, 2018 \\ % Date the experiment was performed
Revision: & 1.3 \\         % revision number
...
Notice how the inline RTL source code is quoted.  
...
register index, utilize a pseudo instruction with an encoding field.  An example set of pseudo instructions is provided 
